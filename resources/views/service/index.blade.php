        ...
        document.addEventListener('DOMContentLoaded', function() {
            @if (!Auth::user() || Auth::user()->role !== 'superadmin')
                ...
                document.body.innerHTML =
                    '<div class="flex items-center justify-center min-h-screen text-2xl text-red-600 font-bold">Accès réservé au superadmin</div>';
            @endif
        });
    </script>
    <div class="max-w-2xl mx-auto mt-12 bg-white rounded-2xl p-4 sm:p-8">
        <h2 class="text-2xl font-bold mb-6 text-blue-accent text-center uppercase">Gérer les Services Externes</h2>
        @if (session('success'))
            ...
            <tbody>
                @foreach ($services as $service)
                    <tr class="border-b hover:bg-off-white transition text-center"
                        ...
                        <td class="py-3 px-4 break-words max-w-[120px] sm:max-w-none">
