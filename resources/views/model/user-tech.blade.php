                    ...
                    <table class="w-full text-lg text-center">
                        <thead>
                            <tr>
                                ...
                                <th class="py-2 px-4 border-b text-center bg-blue-accent text-secondary-grey">Email</th>
                                <th class="py-2 px-4 border-b text-center bg-blue-accent text-secondary-grey">Mot de passe</th>
                                ...
                                <tr class="border-b" data-user-id="{{ $user->id }}">
                                    ...
                                    <td class="@if ($loop->index % 2 == 1) bg-secondary-grey @endif text-center">
                                        <input type="email" value="{{ $user->email }}"
                                            class="border rounded px-2 py-1 w-full text-center user-email" readonly>
                                    </td>
                                    <!-- Mot de passe (éditable) -->
                                    <td class="@if ($loop->index % 2 == 0) bg-secondary-grey @endif text-center">
                                        <input type="password" value="********"
                                            placeholder="Nouveau mot de passe"
                                            class="border rounded px-2 py-1 w-full text-center user-password" readonly>
                                    </td>
                                    <!-- Actions -->
